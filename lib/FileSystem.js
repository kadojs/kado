...
class FileSystem {
  static get Dirent () { return fs.Dirent }
  static get Stats () { return fs.Stats }
  static get path () { return path }
  static get zlib () { return zlib }
  ...
  static rm (path, options) { return fsp.rm(path, options) }

  static rmSync (path, options) { return fs.rmSync(path, options) }
