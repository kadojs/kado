...
class Kado {
  constructor(config,configLocal){
    ...
    this.Asset = require('./Asset')
    this.Breadcrumb = require('./Breadcrumb')
    this.CommandServer = require('./CommandServer')
    ...
    this.LogHelper = require('./logger/winston')
    ...
    this.log = new this.LogHelper().getLog()
    this.determinePaths()
    this.loadDefaultConfig()
    this.setDevMode()
    this.saveOriginalConfig()
    this.asset = new this.Asset()
    this.breadcrumb = new this.Breadcrumb()
