...
const hOP = (o, v) => {
  return Validate.isType('object', o) ? Object.prototype.hasOwnProperty.call(o, v)
    : false
}
...
class Mustache {
  static getInstance (opts) {
    if (!Validate.isType('Mustache', defaultInstance)) {
      defaultInstance = new Mustache(opts)
    }
  ...
  constructor (opts) {
    ...
    */
    console.log('constructed', Validate.getType(this))
    console.log('typeOf render', Validate.getType(this.render))
  }
