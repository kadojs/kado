...
class Model extends Mapper {
  ...
  static fieldDate (nullable = false, writable = true) {
    return { type: 'DATETIME', nullable: nullable, writable: writable }
  }

  static fieldNumber (defaultValue = '0', signed = true, nullable = false) {
    return {
      type: 'INT',
      nullable: nullable,
      signed: signed,
  ...
  static fieldPositiveNumber (defaultValue = '0', nullable = false) {
    return Model.fieldNumber(defaultValue, false, nullable)
  }

  static fieldPrimary (autoIncrement = true) {
    return {
      type: 'INT',
      length: '11',
      nullable: false,
