...
const typeMap = {
  ...
  'video/ogg': {
    magic: [[0x80, 0x74, 0x68, 0x65, 0x6F, 0x72, 0x61],
  ...
  'audio/ogg': {
    magic: [[0x7F, 0x46, 0x4C, 0x41, 0x43],
  ...
  'font/woff': {
    magic: ['wOFF', { bytes: [0x00, 0x01, 0x00, 0x00], offset: 4 },
      { string: 'OTTO', offset: 4 } ],
    ext: ['woff']
  },
  'font/woff2': {
    magic: {
      bytes: [['wOF2', { bytes: [0x00, 0x01, 0x00, 0x00], offset: 4 }, { string: 'OTTO',
        offset: 4} ] ],
    ext: ['woff2']
  },
  'audio/x-dsf': {
  ...
  'image/x-adobe-dng': {
    magic: [{ bytes: [0x08, 0x00, 0x00, 0x00], offset: 4 },
  ...
  'video/vnd.avi': {
    magic: [[0x52, 0x49, 0x46, 0x46], { bytes: [0x41, 0x56, 0x49], offset: 8 } ],
    ext: ['avi']
  },
  'audio/vnd.wave': {
  ...
  'image/x-olympus-orf': {
    magic: [[0x49, 0x49, 0x52, 0x4F, 0x08, 0x00, 0x00, 0x00, 0x18] ],
    ext: ['orf']
  },
  'image/x-panasonic-rw2': {
    magic: [[0x49, 0x49, 0x55, 0x00, 0x18, 0x00, 0x00, 0x00, 0x88, 0xE7, 0x74, 0xD8] ],
    ext: ['rw2']
  },
  'video/x-ms-asf': {
    magic: [[0xC0, 0xEF, 0x19, 0xBC, 0x4D, 0x5B, 0xCF, 0x11, 0xA8, 0xFD, 0x00, 0x80, 0x5F, 0x5C, 0x44, 0x2B] ],
    ext: ['wmv', 'asf', 'asx']
  },
  'image/ktx': {
  ...
  'audio/x-ms-wma': {
    magic: [[0x30, 0x26, 0xB2, 0x75, 0x8E, 0x66, 0xCF, 0x11, 0xA6, 0xD9],
  ...
  'application/x-mie': {
    magic: [[0x7E, 0x10, 0x04], [0x7E, 0x18, 0x04], {
      bytes: [0x30, 0x4D, 0x49, 0x45], offset: 4 } ],
    ext: ['mie']
  },
  'application/x-esri-shape': {
    magic: [
      {bytes: [0x27, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00],
      offset: 2 } ],
    ext: ['shp']
  },
  'video/mpeg': {
  ...
  'application/x-tar': {
    magic: [{
      bytes: [0x30, 0x30, 0x30, 0x30, 0x30, 0x30], offset: 148},
  ...
  'application/x-msi': {
    magic: [[0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E] ],
    ext: ['msi']
  },
  'application/mxf': {
    magic: [[0x06, 0x0E, 0x2B, 0x34, 0x02, 0x05, 0x01, 0x01, 0x0D, 0x01, 0x02, 0x01, 0x01, 0x02] ],
    ext: ['mfx']
  },
  'audio/x-s3m': {
    magic: { bytes: ['SCRM', {offset: 44} ],
    ext: ['sem']
  },
  'video/mp2t': {
    magic: [{ bytes: [0x47], offset: 4}, {
  ...
  'application/x.apple.alias': {
    magic:[[0x62, 0x6F, 0x6F, 0x6B, 0x00, 0x00, 0x00, 0x00, 0x6D, 0x61, 0x72, 0x6B, 0x00, 0x00, 0x00, 0x00] ],
    ext: ['alias']
  },
  'application/vnd.ms-fontobject': {
    magic: [{ bytes: [0x4C, 0x50], offset: 34}, {
  ...
  'audio/aac': {
    magic: { bytes: [[0x10], {offset: start + 1, mask: [0x16]}, [0x08], {
      offset: start + 1, mask: [0x08]}] },
    ext: ['aac']
  },
  'audio/mpeg': {
    magic: { bytes: [[0x02], {offset: start + 1, mask: [0x06]}, [0x04], {
      offset: start + 1, mask: [0x06]}, [0x06], {
      offset: start + 1, mask: [0x06]},'ID3'] },
    ext: ['mp3', 'mp2', 'mp1']
  },
  'application/x-xpinstall': {
    magic: { bytes: [[0x50, 0x4B, 0x3, 0x4]] },
    ext:['xpi']
  },
  'image/x-sony-arw': {
    magic: {
      bytes: [[0x10, 0xFB, 0x86, 0x01], {
        offset: 4}, [0x08, 0x00, 0x00, 0x00], {
        offset: 4}, [0x00, 0xFE, 0x00, 0x04, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x03, 0x01], {
        offset: 9}] },
    ext: ['arw']
  },
  'video/MP1S': {
    magic: { bytes: [[0x00, 0x00, 0x01, 0xBA], [0x21], {
      offset: 4, mask: [0xF1]}] },
    ext: ['mpg']
  },
  'video/MP2P': {
  ...
  'video/quicktime': {
    magic: {
      bytes: [[0x66, 0x72, 0x65, 0x65], {
        offset: 4}, [0x6D, 0x64, 0x61, 0x74], {
        offset: 4}, [0x6D, 0x6F, 0x6F, 0x76], {
        offset: 4}, [0x77, 0x69, 0x64, 0x65], {offset: 4}] },
    ext: ['mov']
  },
  // types without magic
  ...
  'application/x-zmachine': { ext: ['z1', 'z2', 'z3', 'z4', 'z5', 'z6', 'z7', 'z8'] },
...
const magicMap = {
  ...
  'application/x-apple-diskimage': { magic: { bytes: [[0x78, 0x01]] },
  'application/x-msdownload': { magic: { bytes: [[0x4D, 0x5A]] },
  'application/postscript': { magic: { bytes: [[0x25, 0x21]] },
  'application/x-compress': { magic: { bytes: [[0x1F, 0xA0], [0x1F, 0x9D]] },
  'image/jpeg': { magic: { bytes: [[0xFF, 0xD8, 0xFF]] },
  'image/vnd.ms-photo': { magic: { bytes: [[0x49, 0x49, 0xBC]] },
  'application/gzip': { magic: { bytes: [[0x1F, 0x8B, 0x8]] },
  'image/gif': { magic: { bytes: [[0x47, 0x49, 0x46]] },
  'audio/opus': { magic: { bytes: [[0x4F, 0x70, 0x75, 0x73, 0x48, 0x65, 0x61, 0x64]] },
  'video/ogg': { magic: { bytes: [
      [0x80, 0x74, 0x68, 0x65, 0x6F, 0x72, 0x61],
      [0x01, 0x76, 0x69, 0x64, 0x65, 0x6F, 0x00],
      [0x7F, 0x46, 0x4C, 0x41, 0x43]
    ]
  },
  'image/bpg': { magic: { bytes: [[0x42, 0x50, 0x47, 0xFB]] },
  'application/wasm': { magic: { bytes: [[0x00, 0x61, 0x73, 0x6D]] },
  'image/x-canon-cr2': { magic: { bytes: [[0x49, 0x49, 0x2A, 0x0], 'CR', {offset: 8}] },
  'image/x-nikon-nef': { magic: { bytes: [[0x1C, 0x00, 0xFE, 0x00, {offset: 8}]] },
  'image/tiff': { magic: { bytes: [[0x4D, 0x4D, 0x0, 0x2A]] },
  'application/x-rpm': { magic: { bytes: [[0xED, 0xAB, 0xEE, 0xDB]] },
  'font/otf': { magic: { bytes: [[0x4F, 0x54, 0x54, 0x4F, 0x00]] },
  'video/x-flv': { magic: { bytes: [[0x46, 0x4C, 0x56, 0x01]] },
  'application/x-xz': { magic: { bytes: [[0xFD, 0x37, 0x7A, 0x58, 0x5A, 0x00]] },
  'application/x-apache-arrow': {
    magic: { bytes: [[0x41, 0x52, 0x52, 0x4F, 0x57, 0x31, 0x00, 0x00]] },
  'model/gltf-binary': {
      magic: { bytes: [[0x41, 0x52, 0x52, 0x4F, 0x57, 0x31, 0x00, 0x00]] },
    bytes: [[0x67, 0x6C, 0x54, 0x46, 0x02, 0x00, 0x00, 0x00]] },
  'image/bmp': { magic: { bytes: [[0x42, 0x4D]] },
  'audio/vnd.dolby.dd-raw': { magic: { bytes: [[0x0B, 0x77]] },
  'application/x-bzip2': { magic: { bytes: [[0x42, 0x5A, 0x68]] },
  'audio/x-musepack': { magic: { bytes: ['MP+'] },
  'application/x-shockwave-flash': { magic: { bytes: [[0x57, 0x53, {offset: 1}]] },
  'image/flif': { magic: { bytes: ['FLIF'] },
  'image/vnd.adobe.photoshop': { magic: ['8BPS'], ext: [''] },
  'audio/aiff': { magic: ['FORM'], ext: ['aif'] },
  'audio/ogg': {
    bytes: [[0x7F, 0x46, 0x4C, 0x41, 0x43],
      [0x53, 0x70, 0x65, 0x65, 0x78, 0x20, 0x20]
    ]
  },
  'application/zip': { magic: [ { bytes: [[0x50, 0x4B]] } ],
  'font/woff': {
    magic: [
      'wOFF',
      { bytes: [0x00, 0x01, 0x00, 0x00], offset: 4},
      { string: 'OTTO', offset: 4 }
    ]
  },
  'font/woff2': {
    magic: { bytes: [['wOF2', [0x00, 0x01, 0x00, 0x00], {offset: 4}, 'OTTO', {
      offset: 4} ]] },
  'audio/x-dsf': { bytes: [['DSD ']] },
  'application/x-lzip': { bytes: ['LZIP'] },
  'audio/x-flac': { bytes: ['fLaC'] },
  'audio/wavpack': { bytes: ['wvpk'] },
  'image/x-adobe-dng': { bytes: [[0x08, 0x00, 0x00, 0x00], {
    offset: 4}, [0x2D, 0x00, 0xFE, 0x00], {
    offset: 8}, [0x27, 0x00, 0xFE, 0x00], {offset: 8}] },
  'audio/ape': { bytes: ['MAC '] },
  'video/vnd.avi': {
    bytes: [[0x52, 0x49, 0x46, 0x46], [0x41, 0x56, 0x49], {offset: 8}] },
  'audio/vnd.wave': { bytes: [[0x57, 0x41, 0x56, 0x45], {offset: 8}] },
  ...
  'application/x-mie': { bytes:
      [[0x7E, 0x10, 0x04], [0x7E, 0x18, 0x04], [0x30, 0x4D, 0x49, 0x45], {
    offset: 4}] },
  'application/x-esri-shape': {
    bytes: [
      [0x27, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], {
      offset: 2}] },
  'video/mpeg': { bytes: [[0x0, 0x0, 0x1, 0xBA], [0x0, 0x0, 0x1, 0xB3]] },
  'font/ttf': { bytes: [[0x00, 0x01, 0x00, 0x00, 0x00]] },
  'image/x-icon': { bytes: [[0x00, 0x00, 0x02, 0x00], [0x00, 0x00, 0x01, 0x00]] },
  'audio/x-xm': { bytes: ['Extended Module:'] },
  'audio/x-voc': { bytes: ['Creative Voice File'] },
  'application/x-tar': {
    bytes: [
      [0x30, 0x30, 0x30, 0x30, 0x30, 0x30], {
      offset: 148, mask: [0xF8, 0xF8, 0xF8, 0xF8, 0xF8, 0xF8]},
      [0x30, 0x30, 0x30, 0x30, 0x30, 0x30], {
      offset: 148, mask: [0xF8, 0xF8, 0xF8, 0xF8, 0xF8, 0xF8]}] },
  'application/x-msi': {
    bytes: [
      [0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E]
    ]
  },
  'aplication/mfx': {
    bytes: [
  ...
  'audio/x-s3m': { bytes: ['SCRM', {offset: 44}] },
  'video/mp2t': {
    bytes: [[0x47], {offset: 4}, [0x47], {offset: 192}, [0x47], {offset: 196}] },
  'application/x-mobipocket-ebook': { bytes: [
    [0x42, 0x4F, 0x4F, 0x4B, 0x4D, 0x4F, 0x42, 0x49], {
    offset: 60}] },
  'application/dicom': { bytes: [[0x44, 0x49, 0x43, 0x4D], {offset: 128}] },
  ...
  'application/vnd.ms-fontobject': {
    bytes: [[0x4C, 0x50], {offset: 34}, [0x00, 0x00, 0x01], {
      offset: 8}, [0x01, 0x00, 0x02], {offset: 8}, ] },
  'audio/aac': { bytes: [[0x10], {offset: start + 1, mask: [0x16]}, [0x08], {
    offset: start + 1, mask: [0x08]}] },
  'audio/mpeg': { bytes: [[0x02], {offset: start + 1, mask: [0x06]}, [0x04], {
    offset: start + 1, mask: [0x06]}, [0x06], {
    offset: start + 1, mask: [0x06]}, 'ID3'] },
  'application/x-xpinstall': { bytes: [[0x50, 0x4B, 0x3, 0x4]] },
  'image/x-sony-arw': {
    bytes: [
      [0x10, 0xFB, 0x86, 0x01], {
      offset: 4}, [0x08, 0x00, 0x00, 0x00], {
      offset: 4}, [0x00, 0xFE, 0x00, 0x04, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x03, 0x01], {
      offset: 9}] },
  'video/MP1S': { bytes: [[0x00, 0x00, 0x01, 0xBA], [0x21], {
    offset: 4, mask: [0xF1]}] },
  }
}
