...
const typeMap = {
  ...
  'image/x-canon-cr2': {
    magic: { bytes: [[0x49, 0x49, 0x2A, 0x0], 'CR', {offset: 8}] },
    ext: ['cr2']
  },
  'image/x-nikon-nef': {
  ...
  'font/woff': {
    magic: {
      bytes: [['wOFF', [0x00, 0x01, 0x00, 0x00], {offset: 4}, 'OTTO', {
        offset: 4}]] },
    ext: ['woff']
  },
  'font/woff2': {
    magic: {
      bytes: [['wOF2', [0x00, 0x01, 0x00, 0x00], {offset: 4}, 'OTTO', {
        offset: 4} ]] },
    ext: ['woff2']
  },
  'audio/x-dsf': {
  ...
  'image/x-adobe-dng': {
    magic: {
      bytes: [[0x08, 0x00, 0x00, 0x00], {offset: 4}, [0x2D, 0x00, 0xFE, 0x00], {
  ...
  'video/vnd.avi': {
    magic: {
      bytes: [[0x52, 0x49, 0x46, 0x46], [0x41, 0x56, 0x49], {
        offset: 8}] },
    ext: ['avi']
  },
  'audio/vnd.wave': {
  ...
  'application/x-mie': {
    magic: {
      bytes: [[0x7E, 0x10, 0x04], [0x7E, 0x18, 0x04], [0x30, 0x4D, 0x49, 0x45], {
        offset: 4}] },
    ext: ['mie']
  },
  ...
  'video/mpeg': {
    magic: { bytes: [[0x0, 0x0, 0x1, 0xBA], [0x0, 0x0, 0x1, 0xB3]] },
    ext: ['mpg']
  },
  'font/ttf': {
  ...
  'image/x-icon': {
    magic: { bytes: [[0x00, 0x00, 0x02, 0x00], [0x00, 0x00, 0x01, 0x00]] },
    ext: ['cur', 'ico']
  },
  'audio/x-xm': {
    magic: { bytes: ['Extended Module:'] },
    ext: ['xm']
  },
  'audio/x-voc': {
  ...
  'video/mp2t': {
    magic: { bytes: [[0x47], {offset: 4}, [0x47], {offset: 192}, [0x47], {
      offset: 196}] },
    ext: ['mts']
  },
  'application/x-mobipocket-ebook': {
    magic: { bytes: [[0x42, 0x4F, 0x4F, 0x4B, 0x4D, 0x4F, 0x42, 0x49], {
      offset: 60}] },
    ext: ['prc', 'mobi']
  },
  'application/dicom': {
  ...
  'application/vnd.ms-fontobject': {
    magic: {
      bytes: [[0x4C, 0x50], {offset: 34}, [0x00, 0x00, 0x01], {
        offset: 8}, [0x01, 0x00, 0x02], {
        offset: 8}, [0x02, 0x00, 0x02], {offset: 8}] },
    ext: ['eot']
  },
  'audio/aac': {
  ...
  'application/x-director': { ext: ['dir', 'dcr', 'dxr', 'cst', 'cct', 'cxt', 'w3d', 'fgd', 'swa'] },
...
const magicMap = {
  ...
  'image/x-canon-cr2': { bytes: [[0x49, 0x49, 0x2A, 0x0], 'CR', {offset: 8}] },
