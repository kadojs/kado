...
class Assert extends Validate {
  ...
  static catch (v1, v2, msg, method) {
    ...
    try {
      ...
      const rv = (e instanceof Assert.Error && e.message === msg)
      if (!rv) {
        throw e
      }
      return true
  ...
  static isOk (value, message) {
    ...
    if (!rv) throw new AssertionError(`${message}`)
    return true
  }
...
// catch handlers
Assert.assert.catch = (v1, v2, msg) => {
  return Assert.catch(v1, v2, msg, 'assert')
}
Assert.eq.catch = (v1, v2, msg) => {
  return Assert.catch(v1, v2, msg, 'eq')
}
Assert.eqDeep.catch = (v1, v2, msg) => {
  return Assert.catch(v1, v2, msg, 'eqDeep')
}
Assert.isType.catch = (v1, v2, msg) => {
  return Assert.catch(v1, v2, msg, 'isType')
}
Assert.isAbove.catch = (v1, v2, msg) => {
  return Assert.catch(v1, v2, msg, 'isAbove')
}
Assert.isBelow.catch = (v1, v2, msg) => {
  return Assert.catch(v1, v2, msg, 'isBelow')
}
Assert.minimum.catch = (v1, v2, msg) => {
  return Assert.catch(v1, v2, msg, 'minimum')
}
Assert.maximum.catch = (v1, v2, msg) => {
  return Assert.catch(v1, v2, msg, 'maximum')
}
Assert.neq.catch = (v1, v2, msg) => {
  return Assert.catch(v1, v2, msg, 'neq')
}
Assert.isOk.catch = (value, msg) => {
  return Assert.catch(value, msg, msg, 'isOk')
}
