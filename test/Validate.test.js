...
const test = runner.suite('Validate')
const assert = test.suite('assert')
const eq = test.suite('eq')
const eqDeep = test.suite('eqDeep')
const getInstance = test.suite('getInstance')
const getType = test.suite('getType')
const isType = test.suite('isType')
const isAbove = test.suite('isAbove')
const isBelow = test.suite('isBelow')
const match = test.suite('match')
const maximum = test.suite('maximum')
const minimum = test.suite('minimum')
const neq = test.suite('neq')
const Types = test.suite('Types')
const withInstance = test.suite('withInstance')
